    ...
    return (
        <div className="w-full bg-bgForSeacrchBorder px-4 py-8 flex flex-col items-center mt-[64px] lg:flex-row lg:justify-between lg:px-[90px]">
            <div className="flex flex-col items-center lg:items-start ">
                <h2 className="text-[28px] text-center lg:text-start font-bold mb-4 max-w-[515px]">DPD delivery already available!</h2>
                ...
                <button className="bg-blue-600 text-white text-[14px] px-8 py-4 rounded-full hover:bg-blue-700 max-w-[149px]
