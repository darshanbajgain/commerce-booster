...
const HowToBuy = ({ title, children }) => {
  ...
  return (
    <div className="m-0 pb-6 border-gray-200 shadow-sm lg:mt-6 lg:shadow-none">
      ...
      >
        <h3
          className={`font-bold font-baiserCircle cursor-pointer md:cursor-default lg:text-bodycolor text-[16px] lg:text-[20px] ${
            isOpen ? "text-bgForOrderBtn" : "text-bodycolor"
          }`}
        >
          {title}
        </h3>
