...
const OtherDropDowns = ({ title, children }) => {
  ...
  return (
    <div className=" m-0 p-4  border-gray-200 shadow-sm lg:mt-2 lg:shadow-none">
      ...
      >
        <h3 className="font-bold font-baiserCircle cursor-pointer  md:cursor-default text-[16px]  lg:text-[20px]">
          {title}
        </h3>
        <img
      ...
      <ul className={`lg:mx-0 mt-4 ${isOpen ? "block" : "hidden"} md:block`}>
        {children}
      </ul>
    </div>
  );
