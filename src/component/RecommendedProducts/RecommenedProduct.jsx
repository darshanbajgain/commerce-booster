...
const RecommenedProduct = () => {
  ...
  return (
    <div className="flex flex-col items-center lg:grid grid-cols-1  relative lg:mx-[88px] ">
      ...
      <div
        className="hidden lg:flex flex-col justify-center items-center z-10 hover:bg-gray-500 
                 bg-bgForSeacrchBorder rounded-lg absolute top-96 -right-6 w-8 h-8"
      >
        <img src={arrowForwarBlack} className="w-[17.45px] h-[17.45px]" />
      </div>

      <h1 className="lg:text-left font-baiserCircle font-[700] text-center pb-1 pt-6 text-[24px] lg:text-[28px] lg:mt-3 lg:mb-[34px]">
      ...
      <div className="relative">
        ...
        <div
          className="bg-bgForSeacrchBorder rounded-lg absolute bottom-4 -right-12 md:-right-20 w-8 h-8
