        ...
        <div className="flex gap-x-4">
            ...
            <div className="flex items-center">
                ...
                <div className="relative py-2 px-4">
                    ...
                    <span className="absolute top-0 right-2 w-[18px] h-[18px] flex items-center justify-center text-white 
                            text-[10px] font-[400] bg-bgForMessageNotifaction rounded-full px-1 py-1">12</span>
                </div>
